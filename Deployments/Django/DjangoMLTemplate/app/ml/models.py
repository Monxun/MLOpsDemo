...
# ML Projects / Models / Notebooks / Config / Input
class Project(models.Model):
    '''
    Project name.
    Attributes:
        name: The name of the machine learning project.
        created_at: The date when project was created.
    '''
    name = models.CharField(max_length=128) # load_data.py auto-discovers dir names in ../projects
...
class Model(models.Model):
    ...
    Attributes:
        name: The name of the model, it will be used in API URL,
        created_at: The date when model was created.
    '''
    name = models.CharField(max_length=128)
    project = models.ForeignKey(Project, on_delete=models.CASCADE, related_name='models')
    params = models.JSONField() # serialize dictionary from model params in '../{project_name}/src/models.py'
    created_at = models.DateTimeField(auto_now_add=True, blank=True)
...
class Notebook(models.Model):
    ...
    Attributes:
        name: The name of the notebook, it will be used in API URL,
        created_at: The date when model was created.
    '''
    name = models.CharField(max_length=128)
...
class Config(models.Model):
    '''
    Project config name and params.
    Attributes:
        name: The name of the notebook, it will be used in API URL,
        created_at: The date when model was created.
    '''
    ...
    params = models.JSONField() # serialize param dictionary from values in '../{project_name}/src/config.py'
    created_at = models.DateTimeField(auto_now_add=True, blank=True)
...
class MLAlgorithmStatus(models.Model):
    '''
    The MLAlgorithmStatus represent status of the MLAlgorithm which can change over time.
    Attributes:
